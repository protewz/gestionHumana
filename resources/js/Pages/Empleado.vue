                ...
                <div class="w-full lg:w-3/6">
                    <div class="bg-white shadow-md rounded my-6" v-if="modal==false">
                                ...
                                <tr v-for="(object, index) in this.arrayDatos" :key="index" class="border-b border-blue-100 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                             ...
                                             <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <span v-text="object.Surnames"></span>
                                        </div>
                                    </td>
                                               <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <span v-text="object.Ident_Card"></span>
                                        </div>
                                    </td>
                        ...
                        <div class="bg-green-100 overflow-hidden shadow-x1">
                            <button @click="abrirModal" type="button" class="border border-green-600 bg-orange-700 text-black rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-pink-500 focus:outline-none focus:shadow-outline">
                                Nuevo Empleado
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
                            ...
                            <div class="flex flex-col px-3 py-5 bg-pink-50">
                                <div class="mb-3 space-y-2 w-full">
                                    ...
                                    <input v-model="nombre" placeholder="" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    <p class="text-red text-xs hidden">Please fill out this field.</p>
                                </div>
                                 <div class="mb-3 space-y-2 w-full">
                                    <label class="text-gray-700 select-none font-medium py-2">Apellido</label>
                                    <input v-model="apellido" placeholder="" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    <p class="text-red text-xs hidden">Please fill out this field.</p>
                                </div>
                                 <div class="mb-3 space-y-2 w-full">
                                    <label class="text-gray-700 select-none font-medium py-2">identificacion</label>
                                    <input v-model="identificacion" placeholder="" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    <p class="text-red text-xs hidden">Please fill out this field.</p>
                                </div>
                                 <div class="mb-3 space-y-2 w-full">
                                    <label class="text-gray-700 select-none font-medium py-2">Telefono</label>
                                    <input v-model="telefono" placeholder="" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    <p class="text-red text-xs hidden">Please fill out this field.</p>
                                </div>
                                 <div class="mb-3 space-y-2 w-full">
                                    <label class="text-gray-700 select-none font-medium py-2">Mail</label>
                                    <input v-model="mail" placeholder="" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    <p class="text-red text-xs hidden">Please fill out this field.</p>
                                </div>
                                 <div class="mb-3 space-y-2 w-full">
                                    <label class="text-gray-700 select-none font-medium py-2">Direccion</label>
                                    <input v-model="direccion" placeholder="" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" name="integration[shop_name]" id="integration_shop_name">
                                    <p class="text-red text-xs hidden">Please fill out this field.</p>
                                </div>
                                  <div class="mb-3 space-y-2 w-full">
    ...
    AppLayout
        ...
        methods:
        {
            ...
            ver(data=[])
            {
                ...
                this.apellido=data['Surnames'];
                this.identificacion=data['Ident_Card'];
                this.telefono=data['Phone'];
                this.mail=data['Mail'];
                this.direccion=data['Adrres'];
